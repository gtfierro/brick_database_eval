...
"""
benchqueries['RoomSensors'] = {'sparql': sparql, 'hod': hod}
...
SELECT DISTINCT ?vav ?room ?temp_uuid ?valve_uuid ?damper_uuid ?setpoint_uuid WHERE {
    ...
    ?tempsensor rdf:type brick:Zone_Air_Temperature_Sensor .
    ?tempsensor bf:uuid ?temp_uuid .
    ?vav bf:hasPoint ?valvesensor .
    ?valvesensor rdf:type brick:Heating_Valve_Sensor .
    ?valvesensor bf:uuid ?valve_uuid .
    ?vav bf:hasPoint ?dmpsensor .
    ?dmpsensor rdf:type brick:Damper_Position_Sensor .
    ?dmpsensor bf:uuid ?damper_uuid .
    ?vav bf:hasPoint ?setpoint .
    ?setpoint rdf:type brick:Zone_Temperature_Setpoint .
...
"""
hod = """
SELECT ?vav ?room ?temp_uuid ?valve_uuid ?damper_uuid ?setpoint_uuid WHERE {
    ?vav rdf:type brick:VAV .
    ?vav bf:hasPoint ?tempsensor .
    ?tempsensor rdf:type brick:Zone_Air_Temperature_Sensor .
    ?tempsensor bf:uuid ?temp_uuid .
